...
public class MarioWindow extends JFrame {
    ...
    MarioWindow() {
		...
		bi = gc.createCompatibleImage(1900,1300);
	...
	public void draw() {
		...
		while(true) {
			try {
				...
				g2d.fillRect(0,0,1900,1300); //1216 704
	...
	public static BufferedImage getImage(InputStream picture_input_stream) {
		try {
			//File fp = new File(filename);
			BufferedImage img = ImageIO.read(picture_input_stream);
			return img;
		} catch (IOException e) {
